		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item">
					<a href="javascript:;"><i class="layui-icon">&#xe63c;</i>商品发布</a>
				</li>
				<li class="layui-nav-item">
					<a href="javascript:;"><i class="layui-icon">&#xe61f;</i>购物车管理</a>
				</li>
				<li class="layui-nav-item">
				...
				<ul class="layui-nav hp-nav-none">
					<li class="layui-nav-item">
						<a href="javascript:;"  class="hp-user-name">
							<img src="/img/b.jpg" class="layui-circle-img layui-anim-upbit">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child" style="padding-left: 15px">
							...
							<dd>
								<a class="hp-tab-add" hp-href="model/toSaveInRoomInfo" href="javascript:;" >用户信息添加</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child" style="padding-left: 15px">
							<dd>
								<a class="hp-tab-add" hp-href="model/toShowInRoomInfo" href="javascript:;" >商品信息查询</a>
							</dd>
							<dd>
								<a class="hp-tab-add" hp-href="model/toSaveInRoomInfo" href="javascript:;" >商品信息添加</a>
							</dd>
							<dd>
								<a class="hp-tab-add" hp-href="" href="javascript:;" >消费记录</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child" style="padding-left: 15px">
							<dd>
								<a class="hp-tab-add" hp-href="" href="javascript:;" >购物车信息查询</a>
							</dd>
							<dd>
								<a class="hp-tab-add" hp-href="" href="javascript:;" >购物车信息修改</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child" style="padding-left: 15px">
							<dd>
								<a class="hp-tab-add" hp-href="" href="javascript:;" >订单信息查询</a>
							</dd>
							<dd>
								<a class="hp-tab-add" hp-href="" href="javascript:;" >订单信息修改</a>
							</dd>
						</dl>
					</li>
					<li class="layui-nav-item">
							...
							<div carousel-item style="height: 750px;">
								<div>
									<div class="layui-bg-green demo-carousel">
										<p style="font-size: 30px;">易买网商城管理系统</p>
